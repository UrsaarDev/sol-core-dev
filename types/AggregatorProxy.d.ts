...
interface AggregatorProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class AggregatorProxy extends BaseContract {
  ...
  functions: {
    ...
    getTimestamp(
      _roundId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { updatedAt: BigNumber }>;
