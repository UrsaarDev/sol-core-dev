...
interface MultiSigWalletWithDailyLimitInterface extends ethers.utils.Interface {
  functions: {
...
export type DailyLimitChangeEvent = TypedEvent<
  [BigNumber] & { dailyLimit: BigNumber }
>;
...
export class MultiSigWalletWithDailyLimit extends BaseContract {
  ...
  filters: {
    "DailyLimitChange(uint256)"(
      dailyLimit?: null
    ): TypedEventFilter<[BigNumber], { dailyLimit: BigNumber }>;
