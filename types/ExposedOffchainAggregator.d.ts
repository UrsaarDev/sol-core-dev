...
interface ExposedOffchainAggregatorInterface extends ethers.utils.Interface {
  functions: {
    ...
    "exposedConfigDigestFromConfigData(address,uint64,address[],address[],uint8,uint64,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "exposedConfigDigestFromConfigData",
    values: [
      string,
      BigNumberish,
      string[],
...
export class ExposedOffchainAggregator extends BaseContract {
  ...
  interface: ExposedOffchainAggregatorInterface;
